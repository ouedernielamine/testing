...
description: "Create distinctive, production-grade frontend interfaces with high design quality. Use when: building web components, pages, applications, UI elements, layouts, forms, dashboards, or any visual interface. Generates creative, polished code that avoids generic AI aesthetics."
---
...
Commit to a cohesive aesthetic. Use CSS variables for consistency. Dominant colors with sharp accents outperform timid, evenly-distributed palettes. Vary between light and dark themes across generations.
...
- No two designs should look the same — vary fonts, themes, aesthetics across generations
...
Remember: produce extraordinary creative work. Don't hold back — commit fully to a distinctive vision.
